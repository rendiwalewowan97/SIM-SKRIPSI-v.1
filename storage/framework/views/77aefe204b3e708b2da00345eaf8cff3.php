...
<form
    ...
    <p class="mb-4 text-sm">
        ...
        <a
            ...
            target="_blank"
            href="<?php echo e(route('guidances.file', $guidance)); ?>">
            Download
        </a>
    </p>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\SKRIPSI ORANG\SIM-SKRIPSI-v.1\resources\views/guidances/create.blade.php ENDPATH**/ ?>