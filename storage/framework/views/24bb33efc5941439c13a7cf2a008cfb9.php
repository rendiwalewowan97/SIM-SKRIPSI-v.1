...
<div class="mb-4 rounded bg-white p-4 shadow"><p><b>Mahasiswa:</b> <?php echo e($guidance->student->name); ?></p><p><b>Jenis:</b> <?php echo e(ucfirst($guidance->type)); ?> · <?php echo e($guidance->chapter); ?></p><p class="mt-3 whitespace-pre-line"><?php echo e($guidance->student_note); ?></p><?php if($guidance->file_path): ?><a class="text-indigo-700" target="_blank" href="<?php echo e(route('guidances.file', $guidance)); ?>">Lihat file mahasiswa</a><?php endif; ?></div>
