...
<div class="mx-auto max-w-6xl space-y-6">
    <div class="rounded-xl bg-white p-6 shadow">
        <div class="border-b pb-4">
            <h1 class="text-2xl font-bold"><?php echo e($archive->title); ?></h1>
        ...
        <dl class="mt-6 grid gap-5 md:grid-cols-2">
            <div>
                ...
                <dd><?php echo e($archive->student->name ?? '-'); ?></dd>
            </div>
            <div>
                <dt class="text-sm text-slate-500">Tahun</dt>
                <dd><?php echo e($archive->year); ?></dd>
            </div>
            <div>
                <dt class="text-sm text-slate-500">Keyword</dt>
                <dd><?php echo e($archive->keywords ?: '-'); ?></dd>
            </div>
            <div>
                <dt class="text-sm text-slate-500">Publik</dt>
                <dd><?php echo e($archive->is_public ? 'Ya' : 'Tidak'); ?></dd>
            </div>
        </dl>
        ...
        <!-- <div class="mt-8 border-t pt-6">
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                <a href="<?php echo e(route('archives.preview', [$archive, 'skripsi'])); ?>"
                   target="_blank"
                   class="rounded-lg bg-indigo-600 px-4 py-2 text-center text-white hover:bg-indigo-700">
                    Preview File Skripsi
                </a>

                <a href="<?php echo e(route('archives.download', [$archive, 'skripsi'])); ?>"
                ...
                <?php if($archive->abstract_path): ?>
                    <a href="<?php echo e(route('archives.preview', [$archive, 'abstract'])); ?>"
                       target="_blank"
                       class="rounded-lg bg-slate-700 px-4 py-2 text-center text-white hover:bg-slate-800">
                        Preview Abstrak
                    </a>

                    <a href="<?php echo e(route('archives.download', [$archive, 'abstract'])); ?>"
    ...
    <div class="rounded-xl bg-white p-6 shadow">
        ...
        <iframe src="<?php echo e(route('archives.preview', [$archive, 'skripsi'])); ?>"
    ...
    <?php if($archive->abstract_path): ?>
        <div class="rounded-xl bg-white p-6 shadow">
            ...
            <iframe src="<?php echo e(route('archives.preview', [$archive, 'abstract'])); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SIM-SKRIPSI-PATCHED-ARSIP-PREVIEW\resources\views/archives/show.blade.php ENDPATH**/ ?>