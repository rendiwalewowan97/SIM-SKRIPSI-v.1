        ...
        <nav class="px-4 pb-6 text-base font-semibold">
            ...
            <a href="{{ route('notifications.index') }}"
                ...
                <span id="notificationBadge"
                    class="{{ $sidebarUnreadNotifications ? '' : 'hidden' }} rounded-full bg-red-600 px-2 py-0.5 text-xs font-bold text-white">
        ...
        <div class="flex items-center gap-6">
            ...
            title="Notifikasi">
                ...
                <span id="topNotificationBadge"
                    class="{{ $topUnreadNotifications ? '' : 'hidden' }} absolute -right-1.5 -top-1.5 flex h-5 min-w-5 items-center justify-center rounded-full bg-red-600 px-1 text-xs font-bold text-white ring-2 ring-white">
